...
CREATE TABLE user_oauth (
    id INT PRIMARY KEY AUTO_INCREMENT,                 -- OAuth 레코드 고유 ID
    user_id INT NOT NULL,                              -- users 테이블의 외래 키
...
CREATE TABLE cv (
    id INT PRIMARY KEY AUTO_INCREMENT,                 -- CV 고유 ID
    user_id INT NOT NULL,                              -- users 테이블 외래 키
...
-- 채용 공고 테이블
CREATE TABLE jobs (
    id INT PRIMARY KEY AUTO_INCREMENT,                 -- 공고 고유 ID
...
CREATE TABLE cv_feedback (
    id INT PRIMARY KEY AUTO_INCREMENT,                 -- 피드백 고유 ID
    cv_id INT NOT NULL,                                -- 어떤 이력서에 대한 피드백인지
    job_id INT NOT NULL,                               -- 어떤 공고와 비교한 피드백인지
...
CREATE TABLE bookmarks (
    id INT PRIMARY KEY AUTO_INCREMENT,                 -- 북마크 고유 ID
    user_id INT NOT NULL,                              -- 북마크한 사용자
    job_id INT NOT NULL,                               -- 북마크한 공고
...
CREATE TABLE applications (
    id INT PRIMARY KEY AUTO_INCREMENT,                 -- 지원 이력 고유 ID
    user_id INT NOT NULL,                              -- 지원한 사용자
    job_id INT NOT NULL,                               -- 지원한 공고
...
CREATE TABLE admin_logs (
    id INT PRIMARY KEY AUTO_INCREMENT,                 -- 로그 고유 ID
    admin_id INT NOT NULL,                             -- 작업한 관리자 ID
...
CREATE TABLE search_history (
    id INT PRIMARY KEY AUTO_INCREMENT,                 -- 검색 기록 ID
